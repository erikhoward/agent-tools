---
description: Shape a new idea into a concept or refine an existing one — collaborative ideation with a persistent concept brief
agent: build
...
- **Greenfield**: they bring a fuzzy new idea to shape into an attackable concept.
