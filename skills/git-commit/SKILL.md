...
> Note: casing, punctuation, and the 72-character limit are Angular-style conventions adopted here for consistency — the Conventional Commits 1.0.0 spec itself does not mandate casing or line length.
